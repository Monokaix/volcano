...
Administrator can create two queues with deserved capacity configured and the deserved resource can be reclaim back. For example, we consume there are 2 orgs xxx,
