...
func (e *extendResource) SupportOverSubscription(node *v1.Node) bool {
	return utilnode.IsNodeSupportOverSubscription(node)
}

func (e *extendResource) ShouldEvict(node *v1.Node, resName v1.ResourceName, resList *utilnode.ResourceList, hasPressure bool) bool {
	return utilnode.IsNodeSupportOverSubscription(node) && hasPressure
}

func (e *extendResource) ShouldUpdateOverSubscription(node *v1.Node, resource apis.Resource) bool {
...
func (e *extendResource) CalOverSubscriptionResources() {
	...
	currentUsage := e.usageGetter.UsagesByValue(includeGuaranteedPods, e.config.GenericConfiguration.IncludeSystemUsage)
