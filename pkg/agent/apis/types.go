...
const (
	...
	// PodQosLevelKey define pod qos level, which ranges from -7~7, <0 means offline pod, >=0 means online pod, it's a
	// new api and replacement of PodOverSubscriptionKey, and has higher priority.
	...
	ColocationEnableNodeLabelKey = "volcano.sh/" + NodeColocationEnable
	// OverSubscriptionNodeLabelKey define if a node is oversubscription
