...
func Test_getter_UsagesByValue(t *testing.T) {
	collector, err := metriccollect.NewMetricCollectorManager(&config.Configuration{}, &cgroup.CgroupManagerImpl{})
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := g.UsagesByValue(tt.includeGuaranteedPods, false); !reflect.DeepEqual(got, tt.want) {
